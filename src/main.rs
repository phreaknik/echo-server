...
pub struct LineCodec; // State memory for line codec
pub struct LineProto; // State memory for line protocol
pub struct EchoService; // State memory for echo service
